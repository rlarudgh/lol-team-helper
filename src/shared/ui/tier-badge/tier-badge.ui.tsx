...
import type { Tier } from "@/shared/types/team-player.types";
...
const tierColors: Record<Tier, string> = {
  ...
  BRONZE:
    "bg-gradient-to-r from-amber-800 to-amber-700 text-white border-amber-600",
  SILVER:
    "bg-gradient-to-r from-gray-500 to-gray-400 text-gray-900 border-gray-300",
  GOLD: "bg-gradient-to-r from-yellow-500 to-yellow-400 text-yellow-900 border-yellow-300",
  PLATINUM:
    "bg-gradient-to-r from-teal-600 to-teal-500 text-white border-teal-400",
  EMERALD:
  ...
  MASTER:
    "bg-gradient-to-r from-purple-700 to-purple-600 text-white border-purple-500",
  GRANDMASTER:
    "bg-gradient-to-r from-red-700 to-red-600 text-white border-red-500",
  CHALLENGER:
    "bg-gradient-to-r from-yellow-400 via-orange-500 to-red-500 text-white border-yellow-300 shadow-lg",
