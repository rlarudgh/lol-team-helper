...
import { TierBadge } from "@/shared/ui/tier-badge/tier-badge.ui";
import { PositionSelector } from "@/features/position-assignment/ui/position-selector.ui";
      ...
      >
        <div className="flex items-center gap-3">
          <Avatar className="h-10 w-10">
            ...
            />
            <AvatarFallback>
              {player.summonerName.slice(0, 2).toUpperCase()}
            </AvatarFallback>
          </Avatar>
          ...
          <div className="flex-1 min-w-0">
            ...
            <div className="mt-1">
              <TierBadge
                ...
                rank={player.rank}
                leaguePoints={
                  showDetailedTier ? player.leaguePoints : undefined
                }
                size="sm"
