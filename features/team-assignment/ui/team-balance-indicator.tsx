...
export function TeamBalanceIndicator({ redTeam, blueTeam }: TeamBalanceIndicatorProps) {
      ...
      <CardContent className="p-4">
        ...
        <div className="mt-3 grid grid-cols-3 gap-4 text-sm">
          <div className="text-center">
            ...
            <div className="text-muted-foreground">{balance.redStrength.toFixed(1)}</div>
          </div>
          <div className="text-center">
            <div className="font-semibold">차이</div>
            <div className="text-muted-foreground">{balance.difference.toFixed(1)}</div>
          </div>
          <div className="text-center">
            <div className="font-semibold text-secondary">블루팀</div>
            <div className="text-muted-foreground">{balance.blueStrength.toFixed(1)}</div>
          </div>
        </div>
      </CardContent>
    </Card>
